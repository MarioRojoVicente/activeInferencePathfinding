...
class ActiveInference:
    ...
    def generateBMatrix(self):
        ...
        for stateIdx in range(len(self.statesList)):
            ...
            for dir in range(len(DIRECTIONS.keys)):
    ...
    def generateCVectors(self):
        self.cVectors = np.zeros(2,len(self.statesList))
    ...
    def updateCVectorsVisited(self, visitedStateDistribution):
        self.cVectors[:][2] = self.cVectors[:][2] + visitedStateDistribution
    ...
    def generateGVectors(self, currentStates):
        self.updateCVectorsVisited(currentStates)
